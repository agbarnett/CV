...
\newcites{letters}{Selected editorials and letters}
\newcites{books}{Books}
...
a271,a268,a273,a274,a277,a278,a279,a280,a281,a282,a284,a285,a286,a288,a289,a290, % 2021
a275,a283,a287,a291,a292,a293,a294,a295,a296,a297,a298,a299,a300,a301,a302, % 2022?
a303,a304,a305,a306,a307,a308,a309,a310,a312,a313, % 2023
a314,a315,a316,a317,a318,a319,a321,a322,a323,a324,a325,a332,a333, % 2024
a326,a327,a328,a329,a330,a331,a334,a335,a336,a337,a338,a339,a340,a344, % 2025
a341,a342,a343,a345,a346} % 2026
% cut back to selected in 2024
\nociteletters{e5,e7,e8,e9,e14,e18,e19,e22,e21,e23}
%\nociteconfpres{cn1,cn2,cn3,cn4,cn5,cn6,cn7,cn8,cn9,cn10,cn11,cn12,cn13,cn14,cn15,cn16,cn17,cn18,cn19} % stopped updating
\nociteblogs{o1,o2,o3,o4,o5,o6,o8,o9,o10,o12,o14,o15,bl1,o18,bl2,bl2b,bl2c,bl3,bl4,bl5,bl6,bl7,bl8,bl9,bl10,bl11,bl12,bl13,bl14,bl15,bl16,bl19,bl17,bl18,bl20,bl21,bl22,bl23,bl24,bl25,bl26}
...
ORCID: \href{https://orcid.org/0000-0001-6339-0374}{0000-0001-6339-0374}
...
\textbf{Professor}: School of Public Health \& Social Work, Queensland University of Technology, Feb~2017 to present
...
Some context for my publication list:

% tried \arabic{citetotal}
\begin{list}{\labelitemi}{\leftmargin=1.2em}\addtolength{\itemsep}{-0.5\baselineskip}
\item I have removed all journal titles from my publication list to focus on \textit{what} I have published instead of \textit{where}.
\item All articles include a hyperlink at the start of the title
%\item I have 309 peer-reviewed publications, 2~books and 1~book chapter.
%\item My h-index is 81 for Google scholar.
%\item My h-index is 39 for Scopus
%\item 60 of my papers have more than 100 citations.
\item I never accept gift authorship and have made an important contribution to all my publications. I have often helped colleagues with statistical analyses and am thanked in the acknowledgments for these papers.
\end{list}
...
a249,a251,a252,a253,a254,a254,a255,a256,a257,a258,a259,a260,a261,a262,a263,a264,a265,a266,a267,a269,a270,a272,a276, %2020
a271,a268,a273,a274,a277,a278,a279,a280,a281,a282,a284,a285,a286,a288,a289,a290, % 2021
a275,a283,a287,a291,a292,a293,a294,a295,a296,a297,a298,a299,a300,a301,a302,a303, % 2022?
a304,a305,a306,a307,a308,a309,a310,a312,a313, % 2023
a314,a315,a316,a317,a318,a319,a321,a322,a323,a324,a325,a332,a333,  % 2024
a326,a327,a328,a329,a330,a331,a334,a335,a336,a337,a338,a339,a340,a344, % 2025
a341,a342,a343,a345,a346} % 2026
...
I have co-authored two statistical books with Professor Annette Dobson.
\begin{list}{\labelitemi}{\leftmargin=1.2em}\addtolength{\itemsep}{-0.5\baselineskip}
...
\item 7,200 citations (Google scholar)
...
\item Has \textit{R} package containing all the data sets \href{http://cran.r-project.org/web/packages/dobson/index.html}{``dobson''}. Over 31,000 downloads (Jan~2022). % See my.cran.downloads.r on lyra
\end{list}
...
\subsubsection*{Selected chief investigator grants} 
% (total funds = $17.5~million)
%159836+40000+165000+49042+59574+106375+500000+400000+408693+59500+308510+362224+276344+14701+1269867+1146817+498228+41000+2491450+69000+20000+295156+(82000*1.1) + 631370 + 47872+504187 +969193 +2997256+49572+1890238+99052+1496653

\begin{list}{\labelitemi}{\leftmargin=1.2em}\addtolength{\itemsep}{-0.5\baselineskip}

\item National Environment Protection Council ``Expansion of the Multi-City Mortality and Morbidity Study'' CIA: Prof Rod Simpson (University of the Sunshine Coast) my role: CIE (study design, data management, statistical support, report writing) 2003
%\$159,836, 

    Two highly cited publications \citepapers{a15,a16} and 3 conference papers.% \citeconf{c0,c1,c2}.

%\item CellCept Australia Research Grants ``The implications of Brain Death in Donor Lung Injury: Investigation and Blockade of the Endothelin Axis'', CIA: A/Prof John Fraser (Prince Charles), my role: CIG (statistical support), 2008
% \$40,000, 
...
% 553081
\item NHMRC Partnership ``Evaluating hand hygiene interventions and their ability to reduce healthcare associated infection'', CIA: A/Prof Nicholas Graves (QUT), my role: CIF (study design, statistical analysis, report writing), 2010--2012.
% \$500,000 in cash from NHMRC, \$400,000 in cash from ACSQHC, \$408,693 in kind from state and territory governments, 

    Publications: \citepapers{a94,a120,a131,a141,a152,a165,a168,a174,a188,a192}.

\item AusAID ``Are community based infection surveillance and control interventions effective in identifying and responding to emerging zoonotic infectious diseases in developing countries?'', CIA: Dr Kate Halton (QUT), my role: CIB (statistical analysis), 2011
% \$59,500, 

    Publication: \citepapers{akate}.

% APP1023735
\item NHMRC Project ``Building an evidence base for funding evidence-based medicine'', CIA: Adrian Barnett (QUT), 2011--2012, \textbf{Rated Category 6} (top 8.5\% of proposals)
% \$308,510, 

    Publications: \citeletters{e19}, \citepapers{a126,a139,HAQ,a154,a156,a161,a163,a205}, \citeblogs{o10,o12}.

\item NHMRC Project ``Identifying a cost-effective approach to MRSA control in Australia'', CIA: Dr Kate Halton (QUT), my role: CID (statistical analysis), 2011
%  \$362,224

\item NHMRC Project ``Modelling the cost-effectiveness of therapeutic strategies for invasive candidiasis among the ICU population'', CIA: Prof Nick Graves (QUT), my role: CID (statistical analysis), 2011
% \$276,344

\item Australian College of Critical Care Nurses ``High flow nasal cannula for respiratory support in adult intensive care patients. Australian College of Critical Care Nurses'', CIA Amanda Corley (Prince Charles), my role: CIE (statistical support), 2012
% \$14,701,
...
\item AusHSI Stimulus Grant ``Saving blood and money: introduction of laboratory testing guidelines and its effect on blood loss and cost of therapy in an intensive care unit'', CIA: Jayesh Dhanani, 2013.
%\$41,000, 
...
\item Queensland Government Accelerate Partnerships ``CHERISH: better, cheaper hospital care'', CIA: Alison Mudge, my role: CI (statistical analysis and study design) % not sure of dates, 2014--2017.
% , \$498,228

    Publications: \citepapers{a207b, a226, a288}.
...
\item NHMRC Centre for Research Excellence ``Centre for Research Excellence in Advanced Cardio-respiratory Therapies Improving OrgaN Support (ACTIONS)'', CIA: John Fraser, my role: CIG (statistical support and student training), 2015--2019
% \$2,491,450

% Barnett, Platts, Stewart, Fraser, awarded June 2015
\item Heart Foundation Vanguard Grant ``Using thermal clothing to reduce morbidity during winter'', my role: CIA, 2015--2016
% \$69,000, 

   Publication: \citepapers{a203}.

   % PG0115, awarded April 2015
\item Cerebral Palsy Alliance ``Researching the impact of cerebral palsy research'', my role: CIA, 2015--2016
%\$20,000, 

   Publication: \citepapers{a187}.

% DP160103059, announced late 2015
\item ARC Discovery ``Occupational injury prevention in high temperature environments'', CIA: Prof Dino Pisaniello (Adelaide), my role: CIC, 2015--2016
%\$295,156, 

   Publications: \citepapers{a229b,a239,a241,a252,a254}.

% CRRP2016-10MY-Huang, announced June 2016, not in RGMS or qut system
%\item Asia-Pacific Network for Global Change Research ``Assessing the Health Effects of Extreme Temperatures and the Development of Adaptation Strategies to Climate Change in the Asia-Pacific Region'', CIA: Dr Cunrui Huang (Sun Yat-sen University), 
my role: CIC, USD \$82,000, 2016--2017

% APP1117784, announced Sep 2016
% https://eprints.qut.edu.au/98764/ % APP1117784
\item NHMRC Senior Research Fellowship~A ``Meta-research: Using research to increase the value of health and medical research'', 2017--2021
% \$631,370, 

   Publications: \citepapers{a198,a211,a215,a217,a218,a227,a238,a246,a247,a248,a249,a251,a264,a268,a270,a271,a272,a274,a280,a286,a289,a291,a293,a295}

% August 2017; added to RGMS
%\item The Prince Charles Hospital Foundation ``Evaluating and improving the funding processes of The Prince Charles Hospital Foundation'', 2017--2018
% \$47,872, 

% APP1151923, Feb 2018
\item NHMRC Partnership ``Reducing Non-Beneficial Treatment at the End-of-Life'', my role: CIA, 2018--2020
%\$504,187, 

Publications: \citepapers{a265,a302,a315,a319}.

% MRF1175567 Announced June 2019
\item NHMRC Medical Research Future Fund Keeping Australians Out of Hospital ``LOCal Assessment and Triage Evaluation of NAFLD (LOCATE-NAFLD)'', CIA: Adrian Barnett, 2019--2022, \textbf{Rated Category~6}
% \$969,193, 

Publications: \citepapers{a258,a317,a328,a329,a332}

% Announced June 2020
%\item MRFF CHD LIFE+ family-centred care models supporting long-term neurodevelopment, CIA: Steven McPhail, 2020
% \$2,997,256, 

% Announced July 2020
% check I am CI
%\item RBWH and RBWH Foundation Research Project Grants. Gestational diabetes Mellitus screening and diagnosis during COVID-19: changes worth continuing? CIA: Susan de~Jersey, 2020
% \$49,572, 
...
% ID RGS2020037
\item Gold Coast Health Collaborative Research Grant Scheme. Enhancing clinician research: A mixed methods study examining Australian and New Zealand specialist trainees' experiences and research outputs. CIA: Paulina Stehlik, 2021 
% \$99,052, 

Publication: \citepapers{a326}

% ID 2018981
% CIB Professor Steven McPhail CIC - Doctor Bridget Abell CID - Doctor Hannah Carter CIE - Professor Sarah Larkins CIF - Professor Gregory Aarons CIG - Professor Adrian Barnett 
\item NHMRC Partnership. NAVICARE: Implementing, scaling up and sustaining a co-designed care navigation model to improve mental health service access in regional Australia. CIA: Zephanie Tyack, 2023--2025
% \$1,496,653, 

Publication: \citepapers{a324}

% ID = 2029249; announced x
\item NHMRC Ideas Grant ``Problematic articles and literature reviews in molecular cancer research'', 2024--2026, CIA: Jennifer Byrne
% \$442,040, 

Publications: \citepapers{a333,a341,a342}

% UKRI1098 - 5% of my time, announced March 2025; https://www.ukri.org/publications/esrc-metascience-research-grant-awards/
\item UKRI ``Providing empirical evidence to support greater equality, diversity, and inclusion (EDI) in research funding'', 2025--2027, CIA: Philip Clarke
% £212,039, without in-kind £172,039

% announced Dec 2025, $38,046
\item Australian Academy of Science Theo Murphy Initiative ``Essential skills for statistics leadership in consultancy and research', 2026, CIA: Nicole White
...
Published papers: \citepapers{a73,a76,a78}. Linn is now an Associate Professor at the Norwegian University of Science and Technology.
...
Published papers: \citepapers{a75,a90,a96,a97,a103,a115}. 
...
Published papers: \citepapers{a83,a89,a109,a121}. Cunrui was awarded a QUT \textbf{Outstanding Doctoral Thesis Award} in 2013. Cunrui is now a Professor at Tsinghua University.
...
Published papers: \citepapers{a202,a243,a255,a261}
...
Published papers: \citepapers{a235,a240}
...
Published papers: \citepapers{a232,a262,a290}

% Nina Won a Health Practitioner Research Scheme 2018 funding round ($29,636, announced Dec 2017)
% won a QLD Advancing Clinical Research Fellowship (November 2021)
...
Published papers: \citepapers{a216,a242,a253}
...
\item Lee Jones, PhD: Started Oct~2018 (part-time), Investigating relationships between statistical quality and research culture. My percent contribution:~40\%.

Published papers: \citepapers{a330,a335}
...
Published papers: \citepapers{a260,a269,a281}
...
% 
\item Baptiste Scancar (l'Institut Agro Rennes--Angers), Student internship: March to September~2024. My percent contribution:~90\%.

Published paper: \citepapers{a341}

% started July 2024
\item Alex Gibson, PhD: Started~Jul~2024, On Examining Poor Statistical Practices In Published Clinical Prediction Model Research. My percent contribution:~90\%.

% started June 2025, need to check title
\item Tayyebeh Kenarangi, PhD: Started~Jun~2025, Improving the design and analysis of observational registry studies for health and medical research. My percent contribution:~20\%.
...
\item Gerald Schweiger, Vienna University of Technology. 2024.
\item Ran Tian, Statistical Society of Australia. 2025.
\item Grace Xu, QUT. 2025.
\end{list}
...
\subsection{Journals and reviewing}
...
\item Editorial Board of \textit{Epidemiology} 2013--2017, renewed 2015, 2016, 2018 and 2022
...
\item \textit{PLOS Medicine} statistical advisory board (2024--present)
\item Editor for \textit{MetaROR} (2024--present)
\item Reviewed grants for funding agencies in Australia, the Czech Republic, Hong Kong, Israel, UK, Poland and Belgium
\end{list}
...
\item Member Queensland Branch Council (1999--2000, 2010--2015, 2022--2026)
\end{itemize}
...
\item BlueSky: \href{https://bsky.app/profile/aidybarnett.bsky.social}{aidybarnett.bsky.social}
\item Github (data and code-sharing): \href{https://github.com/agbarnett}{agbarnett}
\end{list}
